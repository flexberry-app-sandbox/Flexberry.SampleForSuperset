...
moduleForModel('i-i-s-sample-for-superset-producing-country', 'Unit | Serializer | i-i-s-sample-for-superset-producing-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-sample-for-superset-producing-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
