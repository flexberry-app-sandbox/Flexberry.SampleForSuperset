...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for superset brand l');

test('testing i-i-s-sample-for-superset-brand-l', function(assert) {
  visit('/i-i-s-sample-for-superset-brand-l');
