...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for superset producing country l');

test('testing i-i-s-sample-for-superset-producing-country-l', function(assert) {
  visit('/i-i-s-sample-for-superset-producing-country-l');
