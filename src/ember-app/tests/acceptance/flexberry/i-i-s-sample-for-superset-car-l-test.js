...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for superset car l');

test('testing i-i-s-sample-for-superset-car-l', function(assert) {
  visit('/i-i-s-sample-for-superset-car-l');
